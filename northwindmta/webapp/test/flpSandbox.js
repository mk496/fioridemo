		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwindmta",
									"targetURL": "#northwindmtanorthwindmta-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindmtanorthwindmta-display": {
								"semanticObject": "northwindmtanorthwindmta",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwindmta.northwindmta",
									"url": sap.ui.require.toUrl("northwindmta/northwindmta")
								}
							}
						}
					}
